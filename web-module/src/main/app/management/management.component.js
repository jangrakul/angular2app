...
var ManagementComponent = (function () {
    function ManagementComponent(router, employeeService) {
        this.router = router;
    ...
    ManagementComponent.prototype.ngOnInit = function () {
        ...
        this.employeeService.getEmployees()
            ...
            return _this.employees = employees.slice(8, 10);
        });
    };
    ManagementComponent.prototype.gotoDetail = function (employee) {
